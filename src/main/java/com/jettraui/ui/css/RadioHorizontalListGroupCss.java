 ...
 * @author avbravo
 */
public enum RadioHorizontalListGroupCss {
    ...
    UL("items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white"),
    LI("w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600"),
    ...
    private RadioHorizontalListGroupCss(String css) {
        this.css = css;
    }
}
